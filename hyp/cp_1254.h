/*
 * CHARSET-NAME: MS Windows Codepage 1254 (ANSI Turkish)
 * CODEPAGE-NUMBER: 1254
 */
static h_unichar_t const cp1254_to_unicode[256] = {
...
/* 88 */	0x02c6, 0x2030, 0x0160, 0x2039, 0x0152, 0x008d, 0x008e, 0x008f,
/* 90 */	0x0090, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
/* 98 */	0x02dc, 0x2122, 0x0161, 0x203a, 0x0153, 0x009d, 0x009e, 0x0178,
...
static const unsigned char cp1254_maptab_00[256] = {
...
/* 88 */	0xff, 0xff, 0xff, 0xff, 0xff, 0x8d, 0x8e, 0x8f,
/* 90 */	0x90, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 98 */	0xff, 0xff, 0xff, 0xff, 0xff, 0x9d, 0x9e, 0xff,
...
/* d0 */	0xff, 0xd1, 0xd2, 0xd3, 0xd4, 0xd5, 0xd6, 0xd7,
...
/* f0 */	0xff, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7,
/* f8 */	0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xff, 0xff, 0xff
};

static const unsigned char cp1254_maptab_01[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xd0, 0xf0,
/* 20 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 28 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 30 */	0xdd, 0xfd, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 38 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 40 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 48 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 50 */	0xff, 0xff, 0x8c, 0x9c, 0xff, 0xff, 0xff, 0xff,
/* 58 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xde, 0xfe,
/* 60 */	0x8a, 0x9a, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1254_maptab_02[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1254_maptab_20[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1254_maptab_21[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1254_maptab_22[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char (*const utf16_to_cp1254[256])[256] = {
	&cp1254_maptab_00, &cp1254_maptab_01, &cp1254_maptab_02, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&cp1254_maptab_20, &cp1254_maptab_21, &cp1254_maptab_22, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
