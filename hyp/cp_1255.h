/*
 * CHARSET-NAME: MS Windows Codepage 1255 (ANSI Hebrew)
 * CODEPAGE-NUMBER: 1255
 */
static h_unichar_t const cp1255_to_unicode[256] = {
...
/* 88 */	0x02c6, 0x2030, 0x008a, 0x2039, 0x008c, 0x008d, 0x008e, 0x008f,
/* 90 */	0x0090, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
/* 98 */	0x02dc, 0x2122, 0x009a, 0x203a, 0x009c, 0x009d, 0x009e, 0x009f,
/* a0 */	0x00a0, 0x00a1, 0x00a2, 0x00a3, 0x20aa, 0x00a5, 0x00a6, 0x00a7,
/* a8 */	0x00a8, 0x00a9, 0x00d7, 0x00ab, 0x00ac, 0x00ad, 0x00ae, 0x00af,
/* b0 */	0x00b0, 0x00b1, 0x00b2, 0x00b3, 0x00b4, 0x00b5, 0x00b6, 0x00b7,
/* b8 */	0x00b8, 0x00b9, 0x00f7, 0x00bb, 0x00bc, 0x00bd, 0x00be, 0x00bf,
/* c0 */	0x05b0, 0x05b1, 0x05b2, 0x05b3, 0x05b4, 0x05b5, 0x05b6, 0x05b7,
/* c8 */	0x05b8, 0x05b9, 0x05ba, 0x05bb, 0x05bc, 0x05bd, 0x05be, 0x05bf,
/* d0 */	0x05c0, 0x05c1, 0x05c2, 0x05c3, 0x05f0, 0x05f1, 0x05f2, 0x05f3,
/* d8 */	0x05f4, 0xf88d, 0xf88e, 0xf88f, 0xf890, 0xf891, 0xf892, 0xf893,
...
/* f8 */	0x05e8, 0x05e9, 0x05ea, 0xf894, 0xf895, 0x200e, 0x200f, 0xf896
};

static const unsigned char cp1255_maptab_00[256] = {
...
/* 88 */	0xff, 0xff, 0x8a, 0xff, 0x8c, 0x8d, 0x8e, 0x8f,
/* 90 */	0x90, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 98 */	0xff, 0xff, 0x9a, 0xff, 0x9c, 0x9d, 0x9e, 0x9f,
/* a0 */	0xa0, 0xa1, 0xa2, 0xa3, 0xff, 0xa5, 0xa6, 0xa7,
/* a8 */	0xa8, 0xa9, 0xff, 0xab, 0xac, 0xad, 0xae, 0xaf,
/* b0 */	0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0xb7,
/* b8 */	0xb8, 0xb9, 0xff, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf,
/* c0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* c8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* d0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xaa,
...
/* f0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xba,
/* f8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
};

static const unsigned char cp1255_maptab_01[256] = {
...
static const unsigned char cp1255_maptab_02[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1255_maptab_05[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
/* a0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* b0 */	0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7,
/* b8 */	0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf,
/* c0 */	0xd0, 0xd1, 0xd2, 0xd3, 0xff, 0xff, 0xff, 0xff,
/* c8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* d0 */	0xe0, 0xe1, 0xe2, 0xe3, 0xe4, 0xe5, 0xe6, 0xe7,
/* d8 */	0xe8, 0xe9, 0xea, 0xeb, 0xec, 0xed, 0xee, 0xef,
/* e0 */	0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7,
/* e8 */	0xf8, 0xf9, 0xfa, 0xff, 0xff, 0xff, 0xff, 0xff,
/* f0 */	0xd4, 0xd5, 0xd6, 0xd7, 0xd8, 0xff, 0xff, 0xff,
/* f8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
};

static const unsigned char cp1255_maptab_20[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfd, 0xfe,
...
/* 98 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a8 */	0xff, 0xff, 0xa4, 0xff, 0x80, 0xff, 0xff, 0xff,
/* b0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* b8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* c0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* c8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1255_maptab_21[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1255_maptab_22[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1255_maptab_f8[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
/* 78 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 80 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 88 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xd9, 0xda, 0xdb,
/* 90 */	0xdc, 0xdd, 0xde, 0xdf, 0xfb, 0xfc, 0xff, 0xff,
/* 98 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* b0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char (*const utf16_to_cp1255[256])[256] = {
	&cp1255_maptab_00, &cp1255_maptab_01, &cp1255_maptab_02, &maptab_ff,        &maptab_ff,        &cp1255_maptab_05, &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&cp1255_maptab_20, &cp1255_maptab_21, &cp1255_maptab_22, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	...
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&cp1255_maptab_f8, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff
};
