...
static void show_description(HPDF_Page page, float x, float y, const char *text)
{
	char buf[255];
...
int main(int argc, char **argv)
{
	...
	/* load image file. */
	image = HPDF_LoadPngImageFromFile(pdf, SRCDIR FILE_SEPARATOR "pngsuite" FILE_SEPARATOR "basn3p02.png");

	/* image1 is masked by image2. */
	image1 = HPDF_LoadPngImageFromFile(pdf, SRCDIR FILE_SEPARATOR "pngsuite" FILE_SEPARATOR "basn3p02.png");

	/* image2 is a mask image. */
	image2 = HPDF_LoadPngImageFromFile(pdf, SRCDIR FILE_SEPARATOR "pngsuite" FILE_SEPARATOR "basn0g01.png");

	/* image3 is a RGB-color image. we use this image for color-mask
	 * demo.
	 */
	image3 = HPDF_LoadPngImageFromFile(pdf, SRCDIR FILE_SEPARATOR "pngsuite" FILE_SEPARATOR "maskimage.png");
