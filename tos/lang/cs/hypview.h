...
/* [1][Pøíkaz nemohl být vykonán.|Není dost volné|pamìti.][Zru¹it] */

#define DI_WDIALOG_ERROR                   9 /* Alert string */
/* [1][Prosím nainstalujte systémový|nástroj WDIALOG.PRG][Zru¹it] */

#define DI_VDI_WKS_ERROR                  10 /* Alert string */
/* [1][Nemohu otevøít VDI stanici.][Zru¹it] */
