...
static void show_stripe_pattern(HPDF_Page page, HPDF_REAL x, HPDF_REAL y)
{
	HPDF_UINT iy = 0;
...
static void show_description(HPDF_Page page, HPDF_REAL x, HPDF_REAL y, const char *text)
{
