...
#define APPL_SEARCH 18
#define APPL_EXIT 19
#define APPL_CONTROL 129
#define APPL_GETINFO 130
#define APP_WHAT int_in[0]
#define APP_OUT1 int_out[1]
#define APP_OUT2 int_out[2]
#define APP_OUT3 int_out[3]
#define APP_OUT4 int_out[4]
...
#define OB_GX 	int_out[3]		/* ob_gclip */
