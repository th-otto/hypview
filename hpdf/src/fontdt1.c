...
static HPDF_STATUS LoadAfm(HPDF_FontDef fontdef, HPDF_Stream stream)
{
	...
	for (;;)
	{
		...
		} else if (strcmp(keyword, "FontBBox") == 0)
		{
		...
		} else if (strcmp(keyword, "EncodingScheme") == 0)
		{
