/*
 * CHARSET-NAME: MS Windows Codepage 1258 (ANSI Viet Nam)
 * CODEPAGE-NUMBER: 1258
 */
static h_unichar_t const cp1258_to_unicode[256] = {
...
/* 88 */	0x02c6, 0x2030, 0x008a, 0x2039, 0x0152, 0x008d, 0x008e, 0x008f,
/* 90 */	0x0090, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
/* 98 */	0x02dc, 0x2122, 0x009a, 0x203a, 0x0153, 0x009d, 0x009e, 0x0178,
...
/* c0 */	0x00c0, 0x00c1, 0x00c2, 0x0102, 0x00c4, 0x00c5, 0x00c6, 0x00c7,
/* c8 */	0x00c8, 0x00c9, 0x00ca, 0x00cb, 0x0300, 0x00cd, 0x00ce, 0x00cf,
/* d0 */	0x0110, 0x00d1, 0x0309, 0x00d3, 0x00d4, 0x01a0, 0x00d6, 0x00d7,
/* d8 */	0x00d8, 0x00d9, 0x00da, 0x00db, 0x00dc, 0x01af, 0x0303, 0x00df,
/* e0 */	0x00e0, 0x00e1, 0x00e2, 0x0103, 0x00e4, 0x00e5, 0x00e6, 0x00e7,
/* e8 */	0x00e8, 0x00e9, 0x00ea, 0x00eb, 0x0301, 0x00ed, 0x00ee, 0x00ef,
/* f0 */	0x0111, 0x00f1, 0x0323, 0x00f3, 0x00f4, 0x01a1, 0x00f6, 0x00f7,
/* f8 */	0x00f8, 0x00f9, 0x00fa, 0x00fb, 0x00fc, 0x01b0, 0x20ab, 0x00ff
};

static const unsigned char cp1258_maptab_00[256] = {
...
/* 88 */	0xff, 0xff, 0x8a, 0xff, 0xff, 0x8d, 0x8e, 0x8f,
/* 90 */	0x90, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 98 */	0xff, 0xff, 0x9a, 0xff, 0xff, 0x9d, 0x9e, 0xff,
...
/* c0 */	0xc0, 0xc1, 0xc2, 0xff, 0xc4, 0xc5, 0xc6, 0xc7,
/* c8 */	0xc8, 0xc9, 0xca, 0xcb, 0xff, 0xcd, 0xce, 0xcf,
/* d0 */	0xff, 0xd1, 0xff, 0xd3, 0xd4, 0xff, 0xd6, 0xd7,
/* d8 */	0xd8, 0xd9, 0xda, 0xdb, 0xdc, 0xff, 0xff, 0xdf,
/* e0 */	0xe0, 0xe1, 0xe2, 0xff, 0xe4, 0xe5, 0xe6, 0xe7,
/* e8 */	0xe8, 0xe9, 0xea, 0xeb, 0xff, 0xed, 0xee, 0xef,
/* f0 */	0xff, 0xf1, 0xff, 0xf3, 0xf4, 0xff, 0xf6, 0xf7,
/* f8 */	0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xff, 0xff, 0xff
};

static const unsigned char cp1258_maptab_01[256] = {
/* 00 */	0xff, 0xff, 0xc3, 0xe3, 0xff, 0xff, 0xff, 0xff,
...
/* 78 */	0x9f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 80 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 88 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 90 */	0xff, 0xff, 0x83, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 98 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a0 */	0xd5, 0xf5, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xdd,
/* b0 */	0xfd, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1258_maptab_02[256] = {
...
static const unsigned char cp1258_maptab_03[256] = {
/* 00 */	0xcc, 0xec, 0xff, 0xde, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xd2, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 20 */	0xff, 0xff, 0xff, 0xf2, 0xff, 0xff, 0xff, 0xff,
/* 28 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 30 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 38 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 40 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1258_maptab_20[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
/* 98 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* a8 */	0xff, 0xff, 0xff, 0xfe, 0x80, 0xff, 0xff, 0xff,
/* b0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* b8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* c0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* c8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1258_maptab_21[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1258_maptab_22[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char (*const utf16_to_cp1258[256])[256] = {
	&cp1258_maptab_00, &cp1258_maptab_01, &cp1258_maptab_02, &cp1258_maptab_03, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&cp1258_maptab_20, &cp1258_maptab_21, &cp1258_maptab_22, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
