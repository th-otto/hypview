...
HPDF_Dict HPDF_Dict_New(HPDF_MMgr mmgr)
{
	...
	if (obj)
	{
		memset(obj, 0, sizeof(HPDF_Dict_Rec));
...
static HPDF_STATUS HPDF_Dict_Add_FilterParams(HPDF_Dict dict, HPDF_Dict filterParam)
{
	HPDF_Array paramArray;

	/* prepare params object */
	paramArray = (HPDF_Array) HPDF_Dict_GetItem(dict, "DecodeParms", HPDF_OCLASS_ARRAY);
	if (paramArray == NULL)
	{
