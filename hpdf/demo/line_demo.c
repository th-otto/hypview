...
static void draw_line(HPDF_Page page, float x, float y, const char *label)
{
...
static void draw_line2(HPDF_Page page, float x, float y, const char *label)
{
	HPDF_Page_BeginText(page);
...
static void draw_rect(HPDF_Page page, double x, double y, const char *label)
{
	HPDF_Page_BeginText(page);
	HPDF_Page_MoveTextPos(page, x, y - 10);
	HPDF_Page_ShowText(page, label);
