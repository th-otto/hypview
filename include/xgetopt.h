...
ANONYMOUS_STRUCT_DUMMY(_getopt_data)
#endif
...
int getopt_long_only(int argc, const char **argv, const char *shortopts, const struct option *longopts, int *longind);
