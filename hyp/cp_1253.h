/*
 * CHARSET-NAME: MS Windows Codepage 1253 (ANSI Greek)
 * CODEPAGE-NUMBER: 1253
 */
static h_unichar_t const cp1253_to_unicode[256] = {
...
/* 88 */	0x0088, 0x2030, 0x008a, 0x2039, 0x008c, 0x008d, 0x008e, 0x008f,
/* 90 */	0x0090, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,
/* 98 */	0x0098, 0x2122, 0x009a, 0x203a, 0x009c, 0x009d, 0x009e, 0x009f,
/* a0 */	0x00a0, 0x0385, 0x0386, 0x00a3, 0x00a4, 0x00a5, 0x00a6, 0x00a7,
/* a8 */	0x00a8, 0x00a9, 0xf8f9, 0x00ab, 0x00ac, 0x00ad, 0x00ae, 0x2015,
/* b0 */	0x00b0, 0x00b1, 0x00b2, 0x00b3, 0x0384, 0x00b5, 0x00b6, 0x00b7,
...
/* d0 */	0x03a0, 0x03a1, 0xf8fa, 0x03a3, 0x03a4, 0x03a5, 0x03a6, 0x03a7,
...
/* f8 */	0x03c8, 0x03c9, 0x03ca, 0x03cb, 0x03cc, 0x03cd, 0x03ce, 0xf8fb
};


static const unsigned char cp1253_maptab_00[256] = {
...
/* 88 */	0x88, 0xff, 0x8a, 0xff, 0x8c, 0x8d, 0x8e, 0x8f,
/* 90 */	0x90, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 98 */	0x98, 0xff, 0x9a, 0xff, 0x9c, 0x9d, 0x9e, 0x9f,
/* a0 */	0xa0, 0xff, 0xff, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7,
/* a8 */	0xa8, 0xa9, 0xff, 0xab, 0xac, 0xad, 0xae, 0xff,
/* b0 */	0xb0, 0xb1, 0xb2, 0xb3, 0xff, 0xb5, 0xb6, 0xb7,
/* b8 */	0xff, 0xff, 0xff, 0xbb, 0xff, 0xbd, 0xff, 0xff,
...
static const unsigned char cp1253_maptab_01[256] = {
...
static const unsigned char cp1253_maptab_03[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
/* 70 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 78 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 80 */	0xff, 0xff, 0xff, 0xff, 0xb4, 0xa1, 0xa2, 0xff,
/* 88 */	0xb8, 0xb9, 0xba, 0xff, 0xbc, 0xff, 0xbe, 0xbf,
/* 90 */	0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7,
/* 98 */	0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf,
/* a0 */	0xd0, 0xd1, 0xff, 0xd3, 0xd4, 0xd5, 0xd6, 0xd7,
/* a8 */	0xd8, 0xd9, 0xda, 0xdb, 0xdc, 0xdd, 0xde, 0xdf,
/* b0 */	0xe0, 0xe1, 0xe2, 0xe3, 0xe4, 0xe5, 0xe6, 0xe7,
/* b8 */	0xe8, 0xe9, 0xea, 0xeb, 0xec, 0xed, 0xee, 0xef,
/* c0 */	0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7,
/* c8 */	0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe, 0xff,
/* d0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* d8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* e0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* e8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1253_maptab_20[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0x96, 0x97, 0xaf, 0xff, 0xff,
...
static const unsigned char cp1253_maptab_21[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1253_maptab_22[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char cp1253_maptab_f8[256] = {
/* 00 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 08 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 10 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* 18 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
/* e8 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* f0 */	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
/* f8 */	0xff, 0xaa, 0xd2, 0xff, 0xff, 0xff, 0xff, 0xff
};

static const unsigned char (*const utf16_to_cp1253[256])[256] = {
	&cp1253_maptab_00, &cp1253_maptab_01, &maptab_ff,        &cp1253_maptab_03, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&cp1253_maptab_20, &cp1253_maptab_21, &cp1253_maptab_22, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	...
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,
	&cp1253_maptab_f8, &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff,        &maptab_ff
};
