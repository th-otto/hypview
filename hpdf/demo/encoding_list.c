...
static void draw_graph(HPDF_Page page)
{
	char buf[50];
	int i;
...
static void draw_fonts(HPDF_Page page)
{
	int i;
	int j;
...
int main(int argc, char **argv)
{
	...
	/* load font object */
	font_name = HPDF_LoadType1FontFromFile(pdf,
		SRCDIR FILE_SEPARATOR "type1" FILE_SEPARATOR "a010013l.afm",
		SRCDIR FILE_SEPARATOR "type1" FILE_SEPARATOR "a010013l.pfb");
